...
ListOfPhysicsConstants = [
  ...
  },
  {
    ...
    unitsLatex: "\\frac{m^{3}}{kg\\cdot s^{2}}",
  ...
  },
  {
    ...
    unitsLatex: "N\\cdot\\frac{m^{2}}{C^{2}}",
  ...
  },
  {
    ...
    unitsLatex: "\\frac{W}{m^{2}}\\cdot K^{4}",
