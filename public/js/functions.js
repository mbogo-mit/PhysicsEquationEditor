...
function InitMathFields(mathFieldsLatex, orderedIds){
  ...
  new Promise((resolve) => {
    ExecutionID++;
    EL.GenerateEditorErrorMessages({executionID: ExecutionID, callback: function(){
...
function FindAndUpateVariableByRID(rid,opts = {}){
  ...
  new Promise((resolve) => {
    ExecutionID++;
    EL.GenerateEditorErrorMessages({dontRenderMyVariablesCollection: true, executionID: ExecutionID, callback: function(){
      console.log(ExecutionID);
    }});
    resolve(true);
  });
  ...
  //ExecutionID++;
  //EL.GenerateEditorErrorMessages({dontRenderMyVariablesCollection: true, executionID: ExecutionID});
